...
<div class="container">
  ...
  /* incluir header */
    ...
    if ($sesion){  
      ...
      if($_SESSION["user"]["Tipo"] != 3){
        ...
        $getCita = new Citas();
        $resultado = $getCita->getCitaById($params["Cita"]);
        /* si encontro resultados */
        if(sizeof($resultado) != 0){
             ?>
            <div class="contenido" style="min-height: 1200px;">
            <?php
                include './components/informacionCita.php';
            ?>
            </div>
            <?php
        }else{
  ...
  <script src="js/updateCita.js"></script>
  <script src="js/opCitaCliente.js"></script>