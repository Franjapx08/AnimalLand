        ...
        <div class="col-md-12">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              ...
              <div class="row">
                <ul class="list-group list-group-horizontal-lg">
                    <li class="list-group-item">Nombre completo: <?php  echo $resultado[0]["NombreC"]." ".$resultado[0]["ApellidosC"]; ?></li>
                    <li class="list-group-item">Contacto: <?php echo $resultado[0]["CorreoC"];  ?></li> 
                </ul>
              </div>
                ...
                <ul class="list-group list-group-horizontal-lg">
                  <?php
                    ...
                    if($resultado[0]["Estatus"] == 1){
                        ?>
                         <li class="list-group-item"><button class="btn btn-danger" data-toggle="modal" data-target="#modeloCancelar">Cancelar cita</button></li>
                         <li class="list-group-item"><button class="btn btn-success" data-toggle="modal" data-target="#modalPass">Cita concluida</button></li>
                        <?php
                      }
            ...
            <div class="modal fade" id="modelEliminar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal fade" id="modalPass" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Cita concluida</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                      <button type="button" class="btn btn-success" id="addDiagnostico">Aceptar</button>
                    </div>
                  </div>
                </div> 
              </div>
